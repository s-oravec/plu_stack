...
prompt Installing API - Specifications
@module/api/install_specification.sql

prompt Installing Implementation - Specifications
@module/implementation/install_specification.sql

prompt Installing Implementation - Implementations
@module/implementation/install_implementation.sql

prompt Installing API - Implementations
